...
# ===== 路径配置 =====
PROJECT_DIR = r"C:\Users\huc_o\AndroidStudioProjects\iDracController"
...
def main():
    ...
    print("=" * 50)
    print(f"APK 位置: {apk_signed}")
    size_kb = os.path.getsize(apk_signed) / 1024
    print(f"文件大小: {size_kb:.1f} KB")
    print(f"\n安装命令: adb install \"{apk_signed}\"")
    return 0
